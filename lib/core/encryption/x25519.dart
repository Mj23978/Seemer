...
class X25519 {
  ...
  Future<EncryptionKey> calculateSharedSecret(
      EncryptionKey secretKey, EncryptionKey publicKey) async {
  ...
  EncryptionKey calculateSharedSecretSync(
      EncryptionKey secretKey, EncryptionKey publicKey) {
  ...
  Future<AsymmetricKeyPair> generateKeyPair(Uint8List seed) async {
    return generateKeyPairSync(seed);
  }
  ...
  AsymmetricKeyPair generateKeyPairSync(Uint8List seed) {
    ...
    final secretKey = EncryptionKey(seed);
    ...
    // Return a keypair
    final publicKey = EncryptionKey.withPublicBytes(publicKeyBytes);
