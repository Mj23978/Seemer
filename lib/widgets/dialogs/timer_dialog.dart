            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Center(
                    child: Text(
                      durationToString(
                        formatDuration1(widget.counter -
                            (timer.isActive ? timer.tick.seconds : 0.seconds)), formatDuration2(widget.counter - (timer.isActive ? timer.tick.seconds : 0.seconds))),
                      style: textStyle(
                        context,
                        50,
                        color: Colors.white,
...
String durationToString(int counter1, int counter2) {
  var counterMin =
      counter1 < 10 ? "0${counter1}" : counter1.toString();
  var counterSec =
      counter2 < 10 ? "0${counter2}" : counter2.toString();
  return "$counterMin:$counterSec";
}

int formatDuration1(Duration duration) {
  return (duration.inSeconds / 60).floor();
}

int formatDuration2(Duration duration) {
